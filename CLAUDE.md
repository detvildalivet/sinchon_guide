...
pytest                                     # unit tests (tests/test_recommendation.py — scorer; tests/test_places.py — need-type filter; tests/test_enrichment.py — Google match/parse logic) — no network, no DB
```
